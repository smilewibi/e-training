...
$maxRows_kolom2 = 10;
$pageNum_kolom2 = 0;
if (isset($_GET['pageNum_kolom2'])) {
  $pageNum_kolom2 = $_GET['pageNum_kolom2'];
}
$startRow_kolom2 = $pageNum_kolom2 * $maxRows_kolom2;

mysql_select_db($database_Server_HTC, $Server_HTC);
$query_kolom2 = "SELECT foto, Judul, isi, Detail FROM program1 ORDER BY `no` ASC";
$query_limit_kolom2 = sprintf("%s LIMIT %d, %d", $query_kolom2, $startRow_kolom2, $maxRows_kolom2);
$kolom2 = mysql_query($query_limit_kolom2, $Server_HTC) or die(mysql_error());
$row_kolom2 = mysql_fetch_assoc($kolom2);

if (isset($_GET['totalRows_kolom2'])) {
  $totalRows_kolom2 = $_GET['totalRows_kolom2'];
} else {
  $all_kolom2 = mysql_query($query_kolom2);
  $totalRows_kolom2 = mysql_num_rows($all_kolom2);
}
$totalPages_kolom2 = ceil($totalRows_kolom2/$maxRows_kolom2)-1;
?>
<!doctype html>
...
<body>
  ...
  <!-- it works the same with all jquery version from 1.x to 2.x -->
    ...
    <script>
        ...
        jQuery(document).ready(function ($) {
            ...
            function ScaleSlider() {
                ...
                if (parentWidth)
                    jssor_slider1.$ScaleWidth(Math.max(Math.min(parentWidth, 1500), 582));
                else
    ...
    <center>
    <div id="slider1_container" style="position: relative; width: 1500px; height: 582px; overflow: hidden;">
        <style>
        ...
        <!-- Slides Container --> 
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1500px; height: 582px;
            overflow: hidden;">
            <div>
          <img u="image" src="img/home/01.jpg" /></div>
          <div> 
          <img u="image" src="img/home/02.jpg" /></div>
            <div> 
          <img u="image" src="img/home/03.jpg" /></div>
          <div>
        <img u="image" src="img/home/04.jpg" /></div>
        </div> 
        ...
        <a style="display: none" href="#">jquery slider plugin</a>
    </div>
    </center>
  </div>
  <div id="main">
    <?php do { ?>
    <div id="kolom2">
        <div id="logo"><img src="cpanel/<?php echo $row_kolom2['foto']; ?>"></div>
        <div id="judul">
          <h3><?php echo $row_kolom2['Judul']; ?></h3>
        </div>
        <div id="Isi"><?php echo $row_kolom2['isi']; ?></div>
        <div id="readmore"><a href="#">Detail &gt;&gt;</a></div>
    </div>
      <?php } while ($row_kolom2 = mysql_fetch_assoc($kolom2)); ?>
</div>
<div id="footer">
