...
if (isset($_POST['textfield'])) {
  ...
  $MM_fldUserAuthorization = "Acces";
  $MM_redirectLoginSuccess = "report.php";
  $MM_redirectLoginFailed = "index.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_Server_HTC, $Server_HTC);
  	
  $LoginRS__query=sprintf("SELECT `User`, Pass, Acces FROM `user` WHERE `User`=%s AND Pass=%s",
  ...
  if ($loginFoundUser) {
    ...
    $loginStrGroup  = mysql_result($LoginRS,0,'Acces');
