...
$query_Recordset1 = sprintf("SELECT id_siswa, Nama_dpn, Nm_blkng, Jenkel, Tgl_lhr, Tmpt_lhr, Alamat, No_hp, Email, Foto FROM siswa WHERE Email = %s", GetSQLValueString($colname_Recordset1, "text"));
