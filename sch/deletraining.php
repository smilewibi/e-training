...
if (isset($_GET['Id_tgs'])) {
  $colname_Recordset1 = $_GET['Id_tgs'];
}
mysql_select_db($database_Server_HTC, $Server_HTC);
$query_Recordset1 = sprintf("SELECT * FROM tugas WHERE Id_tgs = %s", GetSQLValueString($colname_Recordset1, "int"));
