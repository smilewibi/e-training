...
mysql_select_db($database_Server_HTC, $Server_HTC);
$query_Recordset1 = sprintf("SELECT Id_materi,materi.Id_guru,materi.Judul_Materi,Tgl,Video,guru.Id_guru,Nma_dpn,Nma_blkng,Foto FROM `materi`,`guru` WHERE materi.Judul_Materi=%s AND materi.Id_guru=guru.Id_guru", GetSQLValueString($colname_Recordset1, "int"));
...
<body>
  ...
  <div id="main">
    ...
    <div id="News">
  <center>
  <form action="edusiswa2.php" method="get" name="">
    <table width="52%" border="0">
        <tr>
          <td width="40%"><p>Cari Berdasarkan Judul</p></td>
          <td>:</td>
          <td width=""><input name="cari" type="text" id="cari" value=""></td>
          <td width=""><input name="" type="submit" onClick="MM_validateForm('cari','','R');return document.MM_returnValue" value="Proses"></td>
          </tr>
      </table>
  </form>
  </center>
      ...
      <center>
        <?php do { ?>
          <div id="Guest">
            <div id="avatar"><img src="<?php echo $row_Recordset1['Foto']; ?>"></div>
            <a href="edusiswa1.php?id=<?php echo $row_Recordset1['Id_materi']; ?>"><h5><?php echo $row_Recordset1['Judul_Materi']; ?> - <?php echo $row_Recordset1['Nma_dpn']; ?> <?php echo $row_Recordset1['Nma_blkng']; ?></h5><?php echo $row_Recordset1['Tgl']; ?></a>
          </div>
