...
mysql_select_db($database_Server_HTC, $Server_HTC);
$query_Recordset1 = "SELECT Id_materi,materi.Id_guru,materi.Judul_Materi,Tgl,Video,guru.Id_guru,Nma_dpn,Nma_blkng,Foto FROM `materi`,`guru` WHERE materi.Id_guru=guru.Id_guru ORDER BY  `Id_materi` DESC ";
