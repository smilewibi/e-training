...
if (isset($_POST['textfield'])) {
  ...
  $MM_redirectLoginSuccess = "admsch.php";
  $MM_redirectLoginFailed = "index.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_Server_HTC, $Server_HTC);
  	
  $LoginRS__query=sprintf("SELECT Email, Pss, Akses FROM guru WHERE Email=%s AND Pss='$encrypt'",
...
<body>
  ...
  <div id="main">
      ...
      <h2>Login</h2>
        ...
        <center>
        <p><a href="lppssgru.php">Lupa Password</a></p>
        </center>
      </div>
      <div id=""></div>
  </div>
