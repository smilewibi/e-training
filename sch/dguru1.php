...
$query_Recordset1 = sprintf("SELECT Id_guru, Nma_dpn, Nma_blkng, Tgl_lhr, Tmpt_lhr, Jengkel, Email, No_hp, Alamat, Kompetensi_inti, Kompetensi_dsr, Judul_materi, Foto FROM guru WHERE Id_guru = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<br><br><br>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
      ...
      <div id="readmore"><a href="dguru.php">&lt;&lt;Kembali</a></div>
    </div>
<div id="main">
 </div>
  </div>
