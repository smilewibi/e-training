...
$query_Recordset1 = sprintf("SELECT id_siswa, Nama_dpn, Nm_blkng, Jenkel, Tgl_lhr, Tmpt_lhr, Alamat, No_hp, Email, Foto FROM siswa WHERE id_siswa = %s ORDER BY Nama_dpn ASC", GetSQLValueString($colname_Recordset1, "int"));
...
<br><br><br>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
      ...
      <div id="readmore"><a href="dsiswa.php">&lt;&lt;Kembali</a></div>
    </div>
<div id="main">
 </div>
  </div>
