...
$query_Recordset1 = "SELECT id_siswa, Nama_dpn, Nm_blkng, Jenkel, Tgl_lhr, Tmpt_lhr, Alamat, No_hp, Email, Foto FROM siswa ORDER BY Nama_dpn ASC";
...
mysql_select_db($database_Server_HTC, $Server_HTC);
$query_Recordset3 = "SELECT id_siswa, Nama_dpn, Nm_blkng FROM siswa";
...
<br><br><br>
  ...
  <div id="News">
  <center>
  <form action="dsiswa2.php" method="get" name="">
    ...
    <div id="News">
      <div id="judul1">
        <h2><?php echo $row_Recordset1['Nama_dpn']; ?> <?php echo $row_Recordset1['Nm_blkng']; ?></h2>
        <div id="date">
          <?php echo $row_Recordset1['Email']; ?>
        </div>
      </div>
      <div id="picture"><img src="<?php echo $row_Recordset1['Foto']; ?>"></div>
      <table width="74%" border="0" cellspacing="0" cellpadding="2">
        <tr>
          <td width="34%">Jenis Kelamin</td>
          <td width="5%">:</td>
          <td width="61%"><?php echo $row_Recordset1['Jenkel']; ?></td>
        </tr>
        <tr>
      ...
      <div id="readmore"><a href="dsiswa1.php?id_siswa=<?php echo $row_Recordset1['id_siswa']; ?>">Read More &gt;&gt;</a></div>
    </div>
