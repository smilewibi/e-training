...
if (isset($_POST['textfield'])) {
  ...
  $MM_redirectLoginSuccess = "etraining.php";
  $MM_redirectLoginFailed = "login.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_Server_HTC, $Server_HTC);
  	
  $LoginRS__query=sprintf("SELECT Email, Pss, akses FROM siswa WHERE Email=%s AND Pss='$encrypt'",
...
<body>
  ...
  <!-- it works the same with all jquery version from 1.x to 2.x -->
    ...
    <center>
    <div id="slider1_container" style="position: relative; width: 1280px;
        ...
        <!-- Slides Container --> 
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1280px; height: 520px;
            overflow: hidden;">
            <div>
  ...
  <div id="main">
      ...
      <h2>Login</h2>
        ...
        <center>
        <p><a href="lppss.php">Lupa Password</a> | <a href="register.php">Daftar</a></p>
        </center>
      </div>
      <div id=""></div>
  </div>
