...
mysql_select_db($database_Server_HTC, $Server_HTC);
$query_Recordset3 = "SELECT `Id_tgs`,tugas.Id_materi,tugas.Id_siswa,tugas.Id_guru,`Date`,`Judul`,`File`,materi.Id_materi,materi.Judul_Materi,materi.Tgl,siswa.id_siswa,siswa.Nama_dpn,siswa.Nm_blkng,siswa.Foto,guru.Id_guru,guru.Nma_dpn,guru.Nma_blkng,guru.Email, tugas.nilai FROM tugas,materi,siswa,guru WHERE guru.Email='$user' AND tugas.Id_materi=materi.Id_materi AND tugas.Id_siswa=siswa.id_siswa AND tugas.Id_guru=guru.Id_guru ORDER BY `Id_tgs` DESC";
    ...
    <div id="News">
      ...
      <p>
              <table width="73%" border="0" cellspacing="0" cellpadding="2">
    			...
    			<td>Nama</td>
    			<td>:</td>
    			<td><?php echo $row_Recordset1['Nma_dpn']; ?> <?php echo $row_Recordset1['Nma_blkng']; ?></td>
  				</tr>
  				<tr>
    			...
    			<td>Jenis Kelamin</td>
    			<td>:</td>
    			<td><?php echo $row_Recordset1['Jengkel']; ?></td>
  				</tr>
  				<tr>
    			<td>Email</td>
    			<td>:</td>
    			...
    			<td>&nbsp;</td>
    			<td>&nbsp;</td>
    			<td><a href="editadmsch.php?Id_guru=<?php echo $row_Recordset1['Id_guru']; ?>">| Edit Profile |</a></td>
  				</tr>
			</table>
      </p>
      </div>
      ...
      <div id="Guest">
        ...
        <table width="100%" border="0">
          ...
          <tr>
            <td colspan="6"><center> 
                <a href="<?php echo $row_Recordset3['File']; ?>">Download</a> | <a href="deladmsch.php?Id_tgs=<?php echo $row_Recordset3['Id_tgs']; ?>">Delete</a>
            | <a href="<?php echo $row_Recordset3['nilai']; ?>">Lihat Nilai</a> | <a href="uploadnilai.php?Id_tgs=<?php echo $row_Recordset3['Id_tgs']; ?>">Upload Nilai</a>
            </center></td>
          </tr>
  </table>
          </p>
