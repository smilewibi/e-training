...
$namafolder="guru/file/htctraining"; //tempat menyimpan file
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $sql="UPDATE tugas SET Id_materi='$id_materi', Id_siswa='$id_siswa', Id_guru='$id_guru', `Date`='$date', Judul='$judul', `File`='$video' WHERE Id_tgs='$id_tgs'";

  mysql_select_db($database_Server_HTC, $Server_HTC);
  $Result1 = mysql_query($sql, $Server_HTC) or die(mysql_error());
	}
  $updateGoTo = "etraining.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_Server_HTC, $Server_HTC);
$query_Recordset3 = sprintf("SELECT * FROM tugas WHERE Id_tgs = %s", GetSQLValueString($colname_Recordset3, "int"));
        ...
        <form method="post" name="form1" action="<?php echo $editFormAction; ?>" enctype="multipart/form-data">
          <table align="center">
            ...
            <tr valign="baseline">
              ...
              <td><input type="text" name="Judul" value="<?php echo htmlentities($row_Recordset3['Judul'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
            </tr>
            <tr valign="baseline">
              <td nowrap align="right">File:</td>
              <td><input type="file" name="nama_file" value="<?php echo htmlentities($row_Recordset3['File'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
            </tr>
            <tr valign="baseline">
          ...
          <input type="hidden" name="Date" value="<?php include('waktu1.php'); ?>">
