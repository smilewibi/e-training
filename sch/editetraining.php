...
$namafolder="guru/img/siswa/siswa"; //tempat menyimpan file
$con=include("../Connections/Server_HTC.php");
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $jenis_gambar=$_FILES['nama_file']['type'];
  $nama_depan=$_POST['Nama_dpn'];
  $Nm_blkng=$_POST['Nm_blkng'];
  $Jenkel=$_POST['Jenkel'];
  $Tgl_lhir=$_POST['Tgl_lhr'];
  ...
  $sql= "UPDATE siswa SET id_siswa='$id_siswa', Nama_dpn='$nama_depan', Nm_blkng='$Nm_blkng', Jenkel='$Jenkel', Tgl_lhr='$Tgl_lhir', Tmpt_lhr='$Tmpt_lhr', Alamat='$Alamat', No_hp='$No_hp', Email='$Email', Pss='$encript', akses='$akses', Foto='$gambar' WHERE id_siswa='$id_siswa' ";
...
if (isset($_GET['id_siswa'])) {
  $colname_Recordset1 = $_GET['id_siswa'];
}
mysql_select_db($database_Server_HTC, $Server_HTC);
$query_Recordset1 = sprintf("SELECT * FROM siswa WHERE id_siswa = %s", GetSQLValueString($colname_Recordset1, "int"));
      ...
      <form method="post" name="form1" action="<?php echo $editFormAction; ?>" enctype="multipart/form-data">
        <table align="center">
          <tr valign="baseline">
            ...
            <td><?php echo $row_Recordset1['id_siswa']; ?></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">Nama Depan :</td>
            <td><input type="text" name="Nama_dpn" value="<?php echo htmlentities($row_Recordset1['Nama_dpn'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">Nama Belakang :</td>
            <td><input type="text" name="Nm_blkng" value="<?php echo htmlentities($row_Recordset1['Nm_blkng'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">Jenis Kelamin :</td>
            <td><select name="Jenkel">
              <option value="Laki-laki" <?php if (!(strcmp("Laki-laki", htmlentities($row_Recordset1['Jenkel'], ENT_COMPAT, 'utf-8')))) {echo "selected=\"selected\"";} ?>>Laki-laki</option>
              <option value="Perempuan" <?php if (!(strcmp("Perempuan", htmlentities($row_Recordset1['Jenkel'], ENT_COMPAT, 'utf-8')))) {echo "selected=\"selected\"";} ?>>Perempuan</option>
            </select></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            ...
            <td><input type="file" name="nama_file" value="<?php echo htmlentities($row_Recordset1['Foto'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">&nbsp;</td>
            <td><input type="submit" onClick="MM_validateForm('Pss','','R');return document.MM_returnValue" value="Update"></td>
          </tr>
        </table>
        <input type="hidden" name="akses" value="<?php echo htmlentities($row_Recordset1['akses'], ENT_COMPAT, 'utf-8'); ?>">
        <input type="hidden" name="MM_update" value="form1">
        <input type="hidden" name="id_siswa" value="<?php echo $row_Recordset1['id_siswa']; ?>">
      </form>
      <p>&nbsp;</p>
<p>&nbsp;</p>
    </div>
