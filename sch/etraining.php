...
$query_Recordset1 = "SELECT id_siswa, Nama_dpn, Nm_blkng, Tgl_lhr, Tmpt_lhr, Jenkel, Email, No_hp, Alamat, Foto FROM siswa WHERE Email='$user'";
...
mysql_select_db($database_Server_HTC, $Server_HTC);
$query_Recordset3 = "SELECT `Id_tgs`,tugas.Id_materi,tugas.Id_siswa,tugas.Id_guru,`Date`,`Judul`,`File`,materi.Id_materi,materi.Judul_Materi,materi.Tgl,siswa.id_siswa,siswa.Nama_dpn,siswa.Nm_blkng,siswa.Email,guru.Id_guru,guru.Nma_dpn,guru.Nma_blkng,guru.Foto, tugas.nilai FROM tugas,materi,siswa,guru WHERE siswa.Email='$user' AND tugas.Id_materi=materi.Id_materi AND tugas.Id_siswa=siswa.id_siswa AND tugas.Id_guru=guru.Id_guru ORDER BY `Id_tgs` DESC";
...
<br><br><br><br><br><br>
  ...
  <h5><?php echo ($_SESSION['MM_Username']);?></h5>
    <div id="News">
      ...
      <p>
              <table width="73%" border="0" cellspacing="0" cellpadding="2">
  <tr>
  ...
  <tr>
    <td>Nama</td>
    <td>:</td>
    <td><?php echo $row_Recordset1['Nama_dpn']; ?> <?php echo $row_Recordset1['Nm_blkng']; ?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Jenis Kelamin</td>
    <td>:</td>
    <td><?php echo $row_Recordset1['Jenkel']; ?></td>
  </tr>
  <tr>
    <td>Email</td>
    <td>:</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="editetraining.php?id_siswa=<?php echo $row_Recordset1['id_siswa']; ?>">| Edit Profile |</a></td>
  </tr>
</table>
      </p>
      </div>
      <div id="News">
      <h4>Tugas <?php echo $row_Recordset1['Nama_dpn']; ?></h4>
      <?php do { ?>
      <div id="Guest">
        <p>
        <table width="100%" border="0">
          <tr>
            <td>Untuk</td>
            <td>:</td>
            <td><?php echo $row_Recordset3['Nma_dpn']; ?> <?php echo $row_Recordset3['Nma_blkng']; ?></td>
            <td>Dari</td>
            <td>:</td>
            <td><?php echo $row_Recordset3['Nama_dpn']; ?> <?php echo $row_Recordset3['Nm_blkng']; ?>(<?php echo $row_Recordset3['Email']; ?>)</td>
            <td rowspan="4"><img width="100" src="<?php echo $row_Recordset3['Foto']; ?>"></td>
          </tr>
          <tr>
            <td>Tugas</td>
            <td>:</td>
            <td><?php echo $row_Recordset3['Judul_Materi']; ?>(<?php echo $row_Recordset3['Tgl']; ?>) </td>
            <td>Tanggal Upload</td>
            <td>:</td>
            <td><?php echo $row_Recordset3['Date']; ?></td>
          </tr>
          <tr>
            <td colspan="6"><center><h3><?php echo $row_Recordset3['Judul']; ?></h3></center></td>
          </tr>
          <tr>
            <td colspan="6"><center> 
                <a href="edittugas.php?Id_tgs=<?php echo $row_Recordset3['Id_tgs']; ?>">Edit</a> | <a href="<?php echo $row_Recordset3['File']; ?>">Download</a> | <a href="<?php echo $row_Recordset3['nilai']; ?>">Lihat Nilai</a> | <a href="deletraining.php?Id_tgs=<?php echo $row_Recordset3['Id_tgs']; ?>">Delete</a>
            </center></td>
          </tr>
  </table>
          </p>
        ...
        <table border="0">
          <tr>
            <td><?php if ($pageNum_Recordset3 > 0) { // Show if not first page ?>
                <a href="<?php printf("%s?pageNum_Recordset3=%d%s", $currentPage, 0, $queryString_Recordset3); ?>"><img src="First.gif"></a>
                <?php } // Show if not first page ?></td>
            <td><?php if ($pageNum_Recordset3 > 0) { // Show if not first page ?>
                <a href="<?php printf("%s?pageNum_Recordset3=%d%s", $currentPage, max(0, $pageNum_Recordset3 - 1), $queryString_Recordset3); ?>"><img src="Previous.gif"></a>
                <?php } // Show if not first page ?></td>
            <td><?php if ($pageNum_Recordset3 < $totalPages_Recordset3) { // Show if not last page ?>
                <a href="<?php printf("%s?pageNum_Recordset3=%d%s", $currentPage, min($totalPages_Recordset3, $pageNum_Recordset3 + 1), $queryString_Recordset3); ?>"><img src="Next.gif"></a>
                <?php } // Show if not last page ?></td>
            <td><?php if ($pageNum_Recordset3 < $totalPages_Recordset3) { // Show if not last page ?>
                <a href="<?php printf("%s?pageNum_Recordset3=%d%s", $currentPage, $totalPages_Recordset3, $queryString_Recordset3); ?>"><img src="Last.gif"></a>
                <?php } // Show if not last page ?></td>
          </tr>
        </table>
      </div>
  ...
  <div id="secondary">
    <div id="panel1">
      ...
      <center>
        ...
        <div id="Guest">
          <div id="avatar"></div>
          <a href="edusiswa1.php?id=<?php echo $row_Recordset2['Id_materi']; ?>">
            <h5><?php echo $row_Recordset2['Judul_Materi']; ?> - <?php echo $row_Recordset2['Nma_dpn']; ?> <?php echo $row_Recordset2['Nma_blkng']; ?></h5>
            <?php echo $row_Recordset2['Tgl']; ?></a> </div>
