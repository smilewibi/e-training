...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
            ...
            $sql="INSERT INTO `siswa` (`Id_siswa`, `Nama_dpn`, `Nm_blkng`, `Jenkel`, `Tgl_lhr`, `Tmpt_lhr`, `Alamat`, `No_hp`, `Email`, `Pss`, `akses`, `Foto`) VALUES ('','$nama_depan','$Nm_blkng','$Jenkel','$Tgl_lhir','$Tmpt_lhr','$Alamat','$No_hp','$Email','$encript','$akses','$gambar')";
      ...
      <form method="post" enctype="multipart/form-data" name="form1" action="<?php echo $editFormAction; ?>">
        <table align="center">
          <tr valign="baseline">
            ...
            <td><input name="Nama_dpn" type="text" id="Nama_dpn" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
            <td nowrap align="right">Nama Belakang:</td>
            <td><input name="Nm_blkng" type="text" id="Nm_blkng" value="" size="32"></td>
          </tr>
          <tr valign="baseline">
          ...
          <tr valign="baseline">
            ...
            <td><input type="submit" onClick="MM_validateForm('Nama_dpn','','R','Nm_blkng','','R','Tgl_lhr','','R','Tmpt_lhr','','R','No_hp','','RisNum','Email','','NisEmail','Pss','','R','Foto','','R','Alamat','','R');return document.MM_returnValue" value="Daftar"></td>
          </tr>
        </table>
