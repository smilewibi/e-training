...
$query_Recordset1 = "SELECT Id_guru, Nma_dpn, Nma_blkng, Tgl_lhr, Tmpt_lhr, Jengkel, Email, No_hp, Alamat, Kompetensi_inti, Kompetensi_dsr, Judul_materi, Foto FROM guru";
...
<br><br><br>
  ...
  <form action="dguru2.php" method="get" name="">
    <table width="52%" border="0">
        <tr>
          <td width="40%"><p>Pencarian Tutor</p></td>
          <td>:</td>
