...
$namafolder="img/guru/guru"; //tempat menyimpan file
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
            ...
            $sql="INSERT INTO `guru` (`Id_guru`, `Nma_dpn`, `Nma_blkng`, `Tgl_lhr`, `Tmpt_lhr`, `Jengkel`, `Email`, `Pss`, `Akses`, `No_hp`, `Alamat`, `Kompetensi_inti`, `Kompetensi_dsr`, `Judul_materi`, `Foto`) VALUES ('', '$nama_depan', '$Nma_blkng', '$Tgl_lhr', '$Tmpt_lhr', '$Jengkel', '$Email', '$Pss', '$Akses', $No_hp, $Alamat, '$Kompetensi_inti', '$Kompetensi_dsr', $Judul_materi, '$gambar')";
    ...
    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
      <table align="center">
        ...
        <tr valign="baseline">
          ...
          <td><input name="Tgl_lhr" type="text" id="Tgl_lhr" value="" size="32"></td>
        </tr>
        <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><input type="submit" onClick="MM_validateForm('Nma_dpn','','R','Nma_blkng','','R','Tgl_lhr','','R','Tmpt_lhr','','R','Email','','RisEmail','Pss','','R','No_hp','','RisNum','Alamat','','R','Kompetensi_inti','','R','Kompetensi_dsr','','R','Judul_materi','','R','Foto','','R');return document.MM_returnValue" value="Daftar"></td>
        </tr>
      </table>
